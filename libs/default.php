...
{//автоподключение классов, без include
...
function myXML($data = array())
{
//  $xml = new XMLWriter(); //создаем новый экземпляр класса XMLWriter
//  $xml->openMemory(); //использование памяти для вывода строки
//  $xml->startDocument('1.0" encoding="UTF-8'); //установка версии XML в первом теге документа
//  if (!empty($data)) {
//    $xml->startElement('item'); //создание корневого узла
...
//  }
//  return $xml->outputMemory(); //завершение записи в XML
